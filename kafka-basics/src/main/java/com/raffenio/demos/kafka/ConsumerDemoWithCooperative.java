...
/**
 ...
 codigo para crear la topic particion por CLI:
...
public class ConsumerDemoWithCooperative {
    ...
    public static void main(String[] args) {
        log.info("I'm a kafka Consumer cooperative");
        ...
        properties.setProperty("partition.assignment.strategy", CooperativeStickyAssignor.class.getName()); //to change how the  partition re-balance work, it should not change partition-consumer and not stop other consumer reading

        //properties.setProperty("group.instance.id","");//this will be the ID of the consumer, for static assigment
        //it also requires the session.time.out property, in order to have some wait time
